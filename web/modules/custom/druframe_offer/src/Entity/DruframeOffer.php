...
/**
 * @file
 * Contains \Drupal\druframe_offer\Entity\DruframeOffer.
 */
...
/**
 * Defines the druframe offer entity.
 *
 * @ingroup druframe_offer
 *
 * @ContentEntityType(
 *   id = "druframe_offer",
 ...
 *        "delete" = "Drupal\druframe_offer\Form\DruframeOfferDeleteForm",
 *      },
 *    },
 *   links = {
 *     "canonical" = "/druframe-offers/{druframe_offer}",
 *     "delete-form" = "/druframe-offer/{druframe_offer}/delete",
 *     "edit-form" = "/druframe-offer/{druframe_offer}/edit",
 *     "create" = "/druframe-offer/create",
 *   },
 * )
 */
Class DruframeOffer extends EditorialContentEntityBase {
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type): array {
    $fields = parent::baseFieldDefinitions($entity_type); // provides id and uuid fields

    $fields['user_id'] = BaseFieldDefinition::create('entity_reference')
      ->setLabel(t("User"))->setDescription(t("The user that created the offer."))
